...
usage(const char* progname)
{
	fprintf(
	    ...
	    "   -L <conf addr>   Specifies the source address for the management server. This may be an IPv4 or IPv6 "
	    "address.\n"
	    ...
	    "   -u <user>:<pass> Specifies a username and password to register into the system. This param may be "
