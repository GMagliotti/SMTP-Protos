...
smtp_state handle_xadm(struct selector_key* key, bool* error, char* msg);
smtp_state handle_ehlo_done(struct selector_key* key, bool* error, char* msg);
