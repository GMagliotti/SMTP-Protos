...
/** Segun el RFC (4.5.3 Sizes and Timeouts), una linea entera de SMTP no debe exceder los 512 caracteres, si restamos \r
 *y \n tenemos 510 caracteres, si restamos el comando 502 caracteres, si restamos el espacio que separa al verbo del
 *argumento 501. Tenemos 502 caracteres para argumentos. En principio, tenemos dos argumentos como maximo: TO:, FROM: y
 *el contenido de estos mas el de HELO, EXPN y VRFY. La maxima longitud para un dominio es 255, si sumamos los <> 257
 **/
...
/** Configuracion del parser de comandos, armamado de la estructura parser_definition, setup de vectores de chars
 * aceptados**/
void parser_configuration();

/** Encargada de ir parseando el comando, es la funcion que llamara a process_char. Necesita del buffer para poder
 * consumir el char Retorna el estado que corresponde
 * **/
